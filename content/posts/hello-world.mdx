...
- Drafted a Data Model\
  ...
  I’ve decided to “borrow” the term [Persona](https://en.wikipedia.org/wiki/Persona_(psychology)) from [Carl Jung](https://en.wikipedia.org/wiki/Carl_Jung) and created an data model based for the roles, masks, areas of life, in which ‘I’ act.
