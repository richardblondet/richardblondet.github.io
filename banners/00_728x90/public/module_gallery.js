...
module_gallery.prototype.createTab = function() {
    ...
    var bn = document.createElement('div');
        bn.className = 'btn_next btn abs prevnext animate';
        bn.innerHTML = '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="12" height="32" viewBox="0 0 12 32"><path fill="#444444" d="M0.002 4.008l11.992 11.992-11.992 11.992v-23.984z"></path></svg>'
        bn.style.color = this.obj.btn_color;

    var bp = document.createElement('div');
        bp.className = 'btn_prev btn abs prevnext animate';
        bp.innerHTML = '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="12" height="32" viewBox="0 0 12 32"><path fill="#444444" d="M0 15.996l11.992 11.992v-23.984l-11.992 11.992z"></path></svg>'
