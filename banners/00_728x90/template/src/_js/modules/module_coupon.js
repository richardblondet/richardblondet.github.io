preloadScripts.push('style_coupon.css');

function module_coupon(obj, num) {
...
module_coupon.prototype.createModule = function() {
    ...
    container.onclick = function(e) {
        self.toggle(1);
        //Enabler.exitOverride('Coupon', self.obj.exit);
    }

}

module_coupon.prototype.createTab = function() {
    ...
    var img = document.createElement('img');
        img.className = 'coupon abs btn';
        img.src = getURL(self.obj.tab);
...
module_coupon.prototype.toggle = function(bool) {
    if(bool)
    {
        addClass(document.getElementById('tab_'+this.num), 'active');
        Enabler.counter('Open Coupon Module', true);
        this.tabActive = true;
    ...
    else
    {
        ...
        Enabler.counter('Close Coupon Module', true);
        this.tabActive = false;
    }
};