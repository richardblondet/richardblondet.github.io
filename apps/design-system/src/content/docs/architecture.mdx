...
Any Decision Records or ADRs is a decision making tool that we are going to use to log every technical decisions for this project.

For new ADRs, please use template.md. More information on MADR is available at https://adr.github.io/madr/.
